...
var file_proto_user_user_proto_rawDesc = []byte{
	...
	0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x68, 0x0a, 0x05,
	...
	0x64, 0x12, 0x33, 0x0a, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x1b, 0x2e, 0x6c, 0x61, 0x72, 0x61, 0x63, 0x6f, 0x6d, 0x2e, 0x75, 0x73, 0x65, 0x72,
...
var file_proto_user_user_proto_goTypes = []interface{}{
	...
	(*Token)(nil),    // 4: laracom.user.service.Token
}
var file_proto_user_user_proto_depIdxs = []int32{
	...
	3, // 3: laracom.user.service.Token.errors:type_name -> laracom.user.service.Error
	0, // 4: laracom.user.service.UserService.Create:input_type -> laracom.user.service.User
	0, // 5: laracom.user.service.UserService.Get:input_type -> laracom.user.service.User
	1, // 6: laracom.user.service.UserService.GetAll:input_type -> laracom.user.service.Request
	0, // 7: laracom.user.service.UserService.Auth:input_type -> laracom.user.service.User
	4, // 8: laracom.user.service.UserService.ValidateToken:input_type -> laracom.user.service.Token
	2, // 9: laracom.user.service.UserService.Create:output_type -> laracom.user.service.Response
	2, // 10: laracom.user.service.UserService.Get:output_type -> laracom.user.service.Response
	2, // 11: laracom.user.service.UserService.GetAll:output_type -> laracom.user.service.Response
	4, // 12: laracom.user.service.UserService.Auth:output_type -> laracom.user.service.Token
	4, // 13: laracom.user.service.UserService.ValidateToken:output_type -> laracom.user.service.Token
